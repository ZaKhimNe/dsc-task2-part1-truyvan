"""
Build QA packages v5 (top-3, mở rộng Điều CÓ ngân sách + dedup) cho 1.000 câu
public-official.
...
OUT_PATH_JSON = config.OUTPUTS_DIR / "qa_packages_public_v5_top3_expand_budget.json"
TOP_N = 3
